...
public partial class BikeStoresContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E2753DAECB5");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B446E4A2EC");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85C91D3046");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229A73A106E");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4EA691A55");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5DC45AE2B");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CFC315B31");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164B0130A12").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D372A20026");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C01FC7A20");
