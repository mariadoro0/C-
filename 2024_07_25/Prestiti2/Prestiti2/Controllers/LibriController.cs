...
namespace PrestitiBiblio.Controllers
{
    public class LibriController : Controller
    {
        ...
        {
            return View(await _context.Libri.OrderBy(x=>x.Titolo).ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //elenco studenti che hanno preso in prestito libro x
            var prestiti = await _context.Prestiti.Include(x=>x.MatricolaNavigation).Where(x=>x.IdLibro == id).ToListAsync();
